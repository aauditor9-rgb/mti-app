...
import { recordPayment } from "@/app/(office)/finance/fees/actions";
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 p-4">
        ...
        <div className="flex items-center gap-3">
          <div className="text-right">
            ...
            <span className={cn("rounded-full px-2 py-0.5 text-tiny font-medium", STATUS_STYLE[householdStatus])}>
              {householdStatus} {totalOutstanding > 0 && `· £${totalOutstanding.toFixed(2)} owed`}
            </span>
          </div>
