  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-4">
      ...
      <div>
        ...
        <h1 className="font-heading text-h2 font-medium text-[var(--ink)]">Process Flows</h1>
      </div>
      <p className="rounded-xl border border-border bg-[var(--surface)] p-8 text-center text-small text-[var(--muted)]">
        Not built yet — no configurable automation rules exist in this app to show here honestly.
      </p>
    </div>
  );
}
